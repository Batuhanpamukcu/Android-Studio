...
import com.batuhanpamukcu.landmarkbook.databinding.RecyclerRowBinding;
...
public class LandmarkAdapter extends RecyclerView.Adapter<LandmarkAdapter.LandmarkHolder> {
    ...
    public void onBindViewHolder(@NonNull LandmarkAdapter.LandmarkHolder holder, int position) {
        // Burada xml degerleri verilecek
    ...
    public int getItemCount() {
        // Burada kac tane oldugu yazilir
